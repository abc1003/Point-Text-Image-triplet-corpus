...
from manager_partal import Managergt as Manager
from models.crapcn1 import CRAPCN, CRAPCN_d
...
def PCNConfig():
    ...
    __C.DATASETS.SHAPENET.CLIPFILE_PATH              =  '../data/PCN/%s/clip_feat/%s/%s/%02d.pt'
